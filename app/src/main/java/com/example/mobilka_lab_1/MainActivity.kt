...
fun FuelOilCalculator(modifier: Modifier = Modifier) {
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        ...
        OutlinedTextField(
            ...
            label = { Text("Enter Lower Heating Value (MJ/kg)") },
            modifier = Modifier.fillMaxWidth(),
            singleLine = true
        )
        OutlinedTextField(
        ...
        OutlinedTextField(
            ...
            label = { Text("Enter Vanadium (mg/kg)") },
            modifier = Modifier.fillMaxWidth(),
            singleLine = true
        )
